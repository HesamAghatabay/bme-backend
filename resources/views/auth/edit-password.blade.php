        ...
        <div class="row justify-content-center mt-130">
            ...
            <div class="col-8">
                ...
                <form method="POST" action="{{ route('password.update', $user->id) }}">
                    ...
                    <input type="oldpassword" name="oldpassword" id="oldpassword" class="form-control mb-4">
                    @error('oldpassword')
                        <p class="f-r mb-4">{{ $message }}</p>
                    @enderror

                    <label for="newpassword" class="form-label"> رمز عبور جدید</label>
                    <input type="newpassword" name="newpassword" id="newpassword" class="form-control mb-4">
                    @error('newpassword')
                        <p class="f-r mb-4">{{ $message }}</p>
                    @enderror
