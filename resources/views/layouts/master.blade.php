            ...
            <div class="comtainer px-3">
                <div class="row justify-content-center align-items-center">
                    <div class="col-12 col-md-6">
                        <video class="video rounded mb-4" muted="" type="video/mp4" id="videoPlayer"
                            controls="">
                        ...
                        <div id="carouselExample" class="carousel slide">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item active">
                                    <a href="">
                                        <img src="./imgs/img-1.jpg" class="d-block img-ostadha rounded shadow"
                                            alt="...">
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a href="">
                                        <img src="./imgs/img-2.jpg" class="d-block img-ostadha rounded shadow"
                                            alt="...">
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a href="">
                                        <img src="./imgs/img-3.jpg" class="d-block img-ostadha rounded shadow"
                                            alt="...">
                                    </a>
                                </div>
                            </div>
                            <div class="d-flex justify-content-center mt-3">
                                ...
                                <a class="mx-1" type="button" data-bs-target="#carouselExample"
                                    data-bs-slide="prev">
